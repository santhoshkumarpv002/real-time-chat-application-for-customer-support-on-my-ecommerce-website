...
Welcome to the Real-Time Customer Support Chat project! This monorepo contains a full-stack, real-time messaging application designed to provide a robust, self-hosted customer support solution.

## 🎯 Project Purpose

Many modern customer support chat solutions rely on third-party SaaS platforms that introduce vendor lock-in, recurring subscription costs, and data privacy concerns. This project aims to solve these problems by providing an open, out-of-the-box, and self-hosted alternative.

By running your own customer support chat infrastructure, you maintain complete control over your users' data, avoid artificial limits on agent seats or message volumes, and can seamlessly integrate the chat experience into your existing internal tools and workflows.
